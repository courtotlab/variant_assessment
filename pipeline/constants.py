...
LLAMA_PROMPTS_PATH = {"1_pass":{"COT":os.path.join(PROMPTS_PATH, "1_pass", "llama_prompts", "llama_prompt_COT.txt"),
                    ...
                    "2_pass":{"COT":(os.path.join(PROMPTS_PATH, "2_pass", "first_pass", "COT.txt"),
                            ...
                            "few_shot_COT":(os.path.join(PROMPTS_PATH, "2_pass", "first_pass", "few_shot_COT_extended.txt"),
                                     os.path.join(PROMPTS_PATH, "2_pass", "second_pass", "few_shot_COT_extended.txt")),
                            ...
                            "one_shot":(os.path.join(PROMPTS_PATH, "2_pass", "first_pass", "one_shot.txt"),
                                     os.path.join(PROMPTS_PATH, "2_pass", "second_pass", "one_shot.txt")),
                            "zero_shot":(os.path.join(PROMPTS_PATH, "2_pass", "first_pass", "zero_shot.txt"),
                                     os.path.join(PROMPTS_PATH, "2_pass", "second_pass", "zero_shot.txt"))}}
