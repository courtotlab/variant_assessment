...
def run_all_passes_on_literature_folder(
    ...
    prompt_pass1="llama prompts first pass/one_shot.txt",
    prompt_pass2="llama prompts two pass/one_shot.txt",
    intermediate_txt_dir="output_llama_2pass_one_shot",
    final_json_dir="output_llama_2pass_one_shot",
